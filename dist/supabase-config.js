...
// ══════════════════════════════════════════════════════════════════
(function () {
  // Evita redeclarar tudo se o arquivo for carregado 2x
  ...
  const SUPA_URL = window.SupabaseInit ? window.SupabaseInit.SUPA_URL : "";
  const SUPA_KEY = window.SupabaseInit ? window.SupabaseInit.SUPA_ANON : "";
